...
ACTION_CODES_MAP: ActionCodesMap = {
    ...
    'get': {'200': 'Успешный запрос.'},
    'post': {'200': 'Успешный запрос.'},
    'patch': {'200': 'Успешный запрос.'},
    'put': {'200': 'Успешный запрос.'},
    'delete': {'204': 'Успешный запрос.'},
    'list': {'200': 'Успешный запрос коллекции.', '400': None, '404': None},
    ...
    'destroy': {'204': ('Успешное удаление объекта.', {}), '400': None},
}
